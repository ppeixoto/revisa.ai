...
$tinybrowser['obfuscate'] = '039vyun30u245cmecopt8mhgefio';
...
// SE O TINYBROWSER FICAR SEMPRE NA MESMA PASTA ISSO DARA CERTO
// PASTA RELATIVA:    (projeto)/js/admin/tinymce/plugins/tinybrowser/
// PASTA DESTINO: 	  (projeto)/imagens/uploads/
$path = "../../../../../";
$tinybrowser['path']['image'] = $path.'imagens/uploads/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $path.'uploads/media/'; // Media files location
$tinybrowser['path']['file']  = $path.'uploads/files/'; // Other files location
...
//ARRUMAR UMA SOLUCAO PARA O ENDERECO DA URL: NAO FUNCIONOU COM SESSION 
$tinybrowser['link']['image'] = "http://10.0.1.35/projetos/2011/sistema/gerenciadorNovo/imagens/uploads/";// Image links
