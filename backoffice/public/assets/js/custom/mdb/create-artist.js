"use strict";
var MDBCreateArtist = function () {
    var e, t, o, r, a, i, n = [];
    return {
        init: function () {
            (e = document.querySelector("#create_artist")) && (new bootstrap.Modal(e), t = document.querySelector("#create_artist_stepper"), o = document.querySelector("#create_artist_form"), r = t.querySelector('[data-kt-stepper-action="submit"]'), a = t.querySelector('[data-kt-stepper-action="next"]'), (i = new KTStepper(t)).on("kt.stepper.changed", (function (e) {
