        ...
        <div class="position-relative" style="z-index: 1;">
            <div class="row align-items-center">
                <div class="col-xl-5 col-lg-6">
                    <div>
                        <h6 class="home-subtitle text-primary mb-4">Entre no Revise Aí</h6>
                        <h1>Informe suas credenciais para ter acesso.</h1>
                        <form method="POST" action="{{ route('signin') }}" enctype="multipart/form-data" class="contact-form mt-4">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-end">
                                    <button name="submit" type="submit" id="submit" class="btn btn-primary">Entrar<i class="mdi mdi-arrow-right"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
