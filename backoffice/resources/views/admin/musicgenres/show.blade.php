...
@section('title', 'Visualizar Estilo Musical')
...
<a href="{{ route('admin.musicgenres.edit', $musicgenre) }}" class="btn btn-sm fw-bold btn-primary">Editar</a>
@endcan
                        ...
                        <div class="d-flex flex-column gap-5 mt-7">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold fs-5">
                                    <span class="badge badge-primary">Código # {{$musicgenre->id}}</span>
                                </div>
                            </div>

                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold text-muted">Nome</div>
                                <div class="fw-bold fs-5">{{$musicgenre->name}}</div>
                            </div>
                        </div>
                    </div>
                </div>
