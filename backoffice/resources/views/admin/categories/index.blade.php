...
@section('buttons')
    @can('categories.create')
        <a href="{{ route('admin.categories.create') }}" class="btn btn-sm fw-bold btn-primary">Adicionar</a>
    @endcan
@endsection
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <div id="kt_table_categories_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="table-responsive">

                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                id="kt_table_categories">
                                <thead>
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_categories"
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ route('admin.categories.show', [$category]) }}"
                                                    class="text-gray-800 text-hover-primary mb-1">{{ $category->name }}
                                                </a>
                                            </td>
                                            @canany(['categories.edit', 'categories.destroy'])
                        ...
                        <x-layouts.shared.pagination :items="$categories" />
