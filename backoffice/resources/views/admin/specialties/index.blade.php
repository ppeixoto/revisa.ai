...
@section('title', 'Funções Integrantes')
...
@section('breadcrumbs')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">Funções Integrantes</li>
    </ul>
@endsection

@section('buttons')
    @can('specialties.create')
        <a href="{{ route('admin.specialties.create') }}" class="btn btn-sm fw-bold btn-primary">Adicionar</a>
    @endcan
@endsection
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                    ...
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <form action="{{ route('admin.specialties.index') }}" method="get">
                                <input type="text" data-kt-category-table-filter="search" name="search"
                ...
                <div class="card-body pt-0">
                    <div id="kt_table_specialties_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="table-responsive">

                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                id="kt_table_specialties">
                                <thead>
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">

                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_specialties"
                                            rowspan="1" colspan="1" style="width: 235.281px;">Nome</th>
                                        @canany(['specialties.edit', 'specialties.destroy'])
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ route('admin.specialties.show', [$specialty]) }}"
                                                    class="text-gray-800 text-hover-primary mb-1">{{ $specialty->name }}
                                                </a>
                                            </td>
                                            @canany(['specialties.edit', 'specialties.destroy'])
                        ...
                        <x-layouts.shared.pagination :items="$specialties" />
