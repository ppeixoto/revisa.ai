...
@section('title', 'Visualizar Operador')
...
@section('buttons')
@can('operators.edit')
<a href="{{ route('admin.operators.edit', $admin) }}" class="btn btn-sm fw-bold btn-primary">Editar</a>
@endcan
                        ...
                        <div class="d-flex flex-column gap-5 mt-7">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold fs-5">
                                    <span class="badge badge-primary">Código # {{$admin->id}}</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-column gap-1">
                                ...
                                <div class="fw-bold fs-5">{{ $admin->email }}</div>
                            </div>
